    ...
    this.confirmationService.confirm({
      ...
      accept: () => {
        ...
        call$.pipe(takeUntilDestroyed(this.destroyRef)).subscribe({
          ...
          error: () => {
            this.messageService.add({ severity: 'error', summary: 'Error', detail: `Failed to ${action} coach` });
          }
        });
      }
    });
      ...
      accept: () => {
        this.coachesService.rejectCoach(coach.id)
          ...
          .subscribe({
            ...
            error: () => {
              this.messageService.add({ severity: 'error', summary: 'Error', detail: 'Failed to reject coach' });
            }
          });
      }
    });
