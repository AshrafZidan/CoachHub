...
@Component({
    ...
    templateUrl:
        './coach-add-appointment.component.html',

    styleUrls: [
        './coach-add-appointment.component.scss',
    ],
...
export class CoachAddAppointmentComponent
    ...
    ngOnInit(): void {
        ...
        if (this.isBrowser) {
            ...
            setTimeout(() => {
                ...
                console.log(
                    '[CoachAppointment] Starting browser initialization'
                );
        ...
        this.profileService
            ...
            .subscribe({
                ...
                error: (err) => {
                    ...
                    this.toast(
                        'error',
                        'Failed to load slots for this month'
                    );
    ...
    hasSlots(
        ...
        return this.datesWithSlots.has(
            `${date.year}-${month}-${day}`
        );
    }
